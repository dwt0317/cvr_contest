...
def build_submission(from_path, to_path):
    ...
    to_file.write(unicode("gbdt_time_gap p2 0.0225"))
...
if __name__ == "__main__":
    ...
    build_submission(constants.project_path + "/out/gbdt_time_gap_p2.out",
                     constants.project_path + "/submission/submission.csv")
    check_submission_cvr(constants.project_path + "/out/gbdt_time_gap_p2.out")
