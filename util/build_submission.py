...
def build_submission(from_path, to_path):
    ...
    to_file.write(unicode("gbdt_noleek_boot_01 0.02640"))
...
if __name__ == "__main__":
    ...
    build_submission(constants.project_path + "/out/gbdt_noleek_boot_01.out",
                     constants.project_path + "/submission/submission.csv")
    check_submission_cvr(constants.project_path + "/out/gbdt_noleek_boot_01.out")
